...
<head>
    ...
    <title>Gezgin Tilki - Dünyayı Keşfet</title>
    <meta name="description"
        content="Unutulmaz tatil deneyimleri ve turlar için Gezgin Tilki yanınızda. Hemen keşfedin!">
        ...
        <div class="container">
            <nav>
                ...
                <div class="nav-links">
                    ...
                    <a href="destinations.php">Destinasyonlar</a>
                    <a href="tours.php">Turlar</a>
                    <a href="about.php">Hakkımızda</a>
                    <a href="contact.php">İletişim</a>
                    <a href="tours.php" class="btn-primary">Rezervasyon Yap</a>
                </div>
                <!-- Mobile Menu Toggle -->
